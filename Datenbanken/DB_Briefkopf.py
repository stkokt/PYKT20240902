...
def create_table():
    ...
    cursor = conn.cursor()
    cursor.execute('CREATE TABLE IF NOT EXISTS tbl_personen (Id INTEGER PRIMARY KEY AUTOINCREMENT,Vorname TEXT,Nachname TEXT,Strasse TEXT,Hausnummer TEXT,PLZ TEXT,Stadt TEXT)')
    conn.commit()
    conn.close()
...
def export_to_csv(filename="telefonbuch.csv"):
    ...
    if data:
        with open(filename, "w", newline="") as file:
            ...
            writer.writerow(["Id", "Vorname", "Nachname", "Strasse", "Hausnummer", "PLZ", "Stadt", "Land", "TelefonNr"])
...
create_table()
#insert_data([["Maximum", "Mustermann","Musterstrasse", "1", "12345", "Berlin"]])
